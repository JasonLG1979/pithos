...
class PithosWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app, test_mode):
        ...
        keyring_error = unlock_keyring()
        if keyring_error:
            self.fatal_error_dialog(
                keyring_error.message,
    ...
    def style_context_change_handler(self, style_context):
        ...
        window_theme_changed = self.current_window_theme_name != current_window_theme_name
        icon_theme_changed = self.current_icon_theme_name != current_icon_theme_name
        if window_theme_changed or icon_theme_changed:
